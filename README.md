...
This is an Expo Push Notification Client for Rust. While there is a community-maintained [Expo Server SDK](https://github.com/expo/expo-server-sdk-rust), it hasn't been updated in the past five years. So I created this crate.
